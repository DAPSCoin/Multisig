...
void CoinControlDialog::updateView()
{
    ...
    for (PAIRTYPE(QString, vector<COutput>) coins : mapCoins) {
        ...
        for(const COutput& out: coins.second) {
            ...
            itemOutput->setData(COLUMN_AMOUNT, Qt::UserRole, QVariant((qlonglong) out.tx->GetTxTime()));
        ...
        if (treeMode) {
            ...
            itemWalletAddress->setData(COLUMN_PRIORITY, Qt::UserRole, QVariant((qlonglong) nSum));
